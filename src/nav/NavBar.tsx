const NavBar = () => {
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark p-3 navbar-wide">
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          <ul className="navbar-nav flex-lg-grow-1 justify-content-lg-evenly ms-lg-4">
            <li className="nav-item">
              <a className="nav-link mx-2 mx-lg-3" aria-current="page" href="/arabic">Arabic</a>
            </li>
            <li className="nav-item">
              <a className="nav-link mx-2 mx-lg-3" href="/english">English</a>
            </li>
            <li className="nav-item">
              <a className="nav-link mx-2 mx-lg-3" href="/cooking">Cooking</a>
            </li>
            <li className="nav-item dropdown">
              <a
                className="nav-link mx-2 mx-lg-3 dropdown-toggle"
                href="#"
