          ...
          <li>
            <a
              ...
              href="https://www.youtube.com/watch?v=FDxL5_UHiyk">
                St. George Coptic Orthodox Church Short Documentary (2020)
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            <a
              ...
              href="https://square.saic.edu/s/article/Send-email-from-a-Google-Group-address">
                How Do I Send Email From A Google Group Address?
            </a>
          </li>
          <li>
            <a
              className="text-decoration-none link-secondary"
              href="http://www.fathermakary.net/">Father Makary</a>
          </li>
          <li>
            <a
              className="text-decoration-none link-secondary"
              href="https://www.logoschannel.com/">Logos</a>
          </li>
          <li>
            <a
              className="text-decoration-none link-secondary"
